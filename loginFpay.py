...
def doLogin(cookiepath, username, password):
    ...
    if not os.path.isfile(cookiepath):
        ...
        cookiepath = os.path.join(cookiepath,'cookiesFPAY.lwp')
    ...
    if username and password:
        ...
        login_url = 'https://fpay.vn/user/login'
	...
	#build the form data necessary for the login
        login_data = urllib.urlencode({'name':username, 'pass':password,'captcha_response':'LfG3P', 'captcha_sid':286343, 'captcha_token':'e189fd7b62d384f998abba8940c2ce3d','op':'Đăng nhập','form_build_id':'form-aARfJqg-23LjMjI5eHf3kaHOuZ-cPAfdnXJddXpZUoU','form_id':'user_login_block'})
